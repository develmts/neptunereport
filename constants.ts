...
export const PARTNERS: Partner[] = [
  {
    ...
    email: 'sterling@meridian-forensics.com'
  },
  {
    id: 'vance',
    ...
    bio: 'Dr. Vance looks beneath the waterline. He translates twisted metal and scorched engine rooms into irrefutable timelines of failure.',
    image: 'https://picsum.photos/id/338/600/800',
    detailedBio: 'Starting as a cadet and rising to Chief Engineer, Marcus went on to earn a PhD in Metallurgy. He bridges the gap between the grease of the engine room and the sterility of the lab. His innovative use of drone-based internal inspections has revolutionized how we document confined space incidents.',
    experience: [
    ...
    email: 'vance@meridian-forensics.com'
  }
];
